...
const Home = () => {
  const profiles = [
    ...
    { id: 3, name: 'Jisoo', bio: 'Chanteuse et danseuse du groupe K-pop BLACKPINK', photo: 'https://cdn-images.dzcdn.net/images/artist/bb48f4fdc1bf6af8b7b8cab275782dc7/1900x1900-000000-80-0-0.jpg' },
    { id: 4, name: 'Jisoo', bio: 'Chanteuse et danseuse du groupe K-pop BLACKPINK', photo: 'https://cdn-images.dzcdn.net/images/artist/bb48f4fdc1bf6af8b7b8cab275782dc7/1900x1900-000000-80-0-0.jpg' },
